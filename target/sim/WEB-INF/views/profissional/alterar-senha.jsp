            ...
            <div class="card-panel"> 
                <div class="card-content">
                    ...
                    <div class="main-content">                        
                        <div class="row">
                            <div class="row">
                                <form class="col s12" id="profForm" name="profForm">                                  
                                    <div class="form1">                                                                                                                                                               
                                        <div class="row">
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="senhaA" type="password" name="senhaA" class="validate" required="true"  ng-model="controller.senhaA" ng-class="{'error-form':profForm.senhaA.$error.maxlength}"  ng-maxlength="15">
                                                <label for="nome">Senha atual</label>
                                                <span class="error" ng-class="error" ng-show="profForm.nome.$error.maxlength">Não é permitido mais que 15 caracteres!</span>
                                            </div> 
                                        </div> 
                                        <div class="row">
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="senhaN" type="password" name="senhaN" class="validate" required="true" ng-model="controller.senhaN" ng-class="{'error-form':profForm.senhaN.$error.maxlength}"  ng-maxlength="15">
                                                <label for="nome">Nova senha</label>
                                                <span class="error" ng-class="error" ng-show="profForm.nome.$error.maxlength">Não é permitido mais que 15 caracteres!</span>
                                            </div>   
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="senhaC" type="password" name="senhaC" class="validate" required="true" ng-model="controller.senhaC" ng-class="{'error-form':profForm.senhaC.$error.maxlength}"  ng-maxlength="15">
