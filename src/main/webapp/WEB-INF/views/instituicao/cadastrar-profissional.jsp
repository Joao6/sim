                            ...
                            <div class="row">
                                <form class="col s12" id="profissionalForm" name="profissionalForm">                                  
                                    <div class="form1">  
                                        ...
                                        <div class="row">
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="nome" type="text" name="nome" class="validate" required="true" ng-model="controller.profissional.nome" ng-class="{'error-form':profissionalForm.nome.$error.maxlength}"  ng-maxlength="60">
                                            ...
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="email" type="email" name="email" class="" required="true" ng-model="controller.profissional.email" ng-blur="controller.validaEmail(controller.profissional.email)" ng-focus="controller.cleanEmailError()" ng-class="{'error-form':profissionalForm.email.$error.maxlength}"  ng-maxlength="60">
                                        ...
                                        <div class="row">
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="senha" type="password" name="senha" class="validate" ng-blur="controller.validarSenha()" ng-model="controller.profissional.senha">
                                                <label for="senha">Senha (Obrigatório)</label>
                                            </div> 
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="confirmaSenha" type="password" name="confirmaSenha" ng-blur="controller.validarSenha()" class="validate">
                                                <label for="confirmaSenha">Confirmar senha (Obrigatório)</label>
                                            </div> 
                                        </div>                                     
                                        <div class="row">
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="profissao" type="text" name="profissao" required="true" class="validate" ng-model="controller.profissional.profissao" ng-class="{'error-form':profissionalForm.profissao.$error.maxlength}"  ng-maxlength="60">
                                            ...
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="telefone" type="text" name="telefone" required="true" class="validate phone_with_ddd" ng-model="controller.profissional.telefone">
                                                <label for="telefone">Telefone (Obrigatório)</label>
                                            </div> 
                                        </div>
                                        <div class="row">
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="cpf" type="text" name="cpf" class="validate cpf" ng-model="controller.profissional.cpf">
                                                <label for="cpf">CPF</label>
                                            </div> 
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="rg" type="text" name="rg" class="validate" ng-model="controller.profissional.rg" ng-class="{'error-form':profissionalForm.rg.$error.maxlength}"  ng-maxlength="15">
                                            ...
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="registroDeConselho" type="text" name="registroDeConselho" class="validate" ng-model="controller.profissional.registroDeConselho" ng-class="{'error-form':profissionalForm.registroDeConselho.$error.maxlength}"  ng-maxlength="40">
                                    ...
                                    <div class="form2">
                                        ...
                                        <div class="row">
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="endereco" type="text" name="endereco" class="validate" ng-model="controller.profissional.endereco" ng-class="{'error-form':profissionalForm.endereco.$error.maxlength}"  ng-maxlength="60">
                                            ...
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="numero" type="text" name="numero" class="validate" ng-model="controller.profissional.numero" ng-class="{'error-form':profissionalForm.numero.$error.maxlength}"  ng-maxlength="10">
                                            ...
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="bairro" type="text" name="bairro" class="validate" ng-model="controller.profissional.bairro" ng-class="{'error-form':profissionalForm.bairro.$error.maxlength}"  ng-maxlength="60">
                                        ...
                                        <div class="row">
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="cidade" type="text" name="cidade" class="validate" ng-model="controller.profissional.cidade" ng-class="{'error-form':profissionalForm.cidade.$error.maxlength}"  ng-maxlength="60">
                                            ...
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="uf" type="text" name="uf" class="validate" ng-model="controller.profissional.uf" ng-class="{'error-form':profissionalForm.uf.$error.maxlength}"  ng-maxlength="2">
                                            ...
                                            <div class="input-field inline col s12 l4 m4">                                            
                                                <input id="cep" type="text" name="cep" class="validate cep" ng-model="controller.profissional.cep">
                                                <label for="cep">CEP</label>
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="botoes">
                                        <button type="button" ng-click="controller.salvarProfissional()" ng-disabled="profissionalForm.$invalid || isEmailOk === false || isSenhaOk === false" class="buttons btn waves-effect waves-light col s12 l3 m3 blue darken-4 right">Cadastrar</button>                                
