                                    ...
                                    <div class="form1">                                                                                                                                                               
                                        <div class="row">
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="senhaA" type="password" name="senhaA" class="validate" required="true"  ng-model="controller.senhaA" ng-class="{'error-form':masterForm.senhaA.$error.maxlength}"  ng-maxlength="15">
                                                <label for="nome">Senha atual</label>
                                                <span class="error" ng-class="error" ng-show="masterForm.nome.$error.maxlength">Não é permitido mais que 15 caracteres!</span>
                                            </div> 
                                        </div> 
                                        <div class="row">
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="senhaN" type="password" name="senhaN" class="validate" required="true" ng-model="controller.senhaN" ng-class="{'error-form':masterForm.senhaN.$error.maxlength}"  ng-maxlength="15">
                                                <label for="nome">Nova senha</label>
                                                <span class="error" ng-class="error" ng-show="masterForm.nome.$error.maxlength">Não é permitido mais que 15 caracteres!</span>
                                            </div>   
                                            <div class="input-field inline col s12 l6 m6">                                            
                                                <input id="senhaC" type="password" name="senhaC" class="validate" required="true" ng-model="controller.senhaC" ng-class="{'error-form':masterForm.senhaC.$error.maxlength}"  ng-maxlength="15">
