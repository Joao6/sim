    ...
    <body class="grey lighten-2" ng-controller="InstituicaoController as controller" ng-init="controller.init()">
        ...
        <div class="modal" id="modal-excluir">
            <div class="modal-content">
                ...
                <p>Obs.: os dados deste profissional serão excluídos de todos os locais. Deseja confirmar esta operação?</p>
            </div>
                ...
                <div class="card-content">
                    ...
                    <div class="main-content">                        
                        <div class="row">
                            ...
                            <div ng-show="controller.profissionalListEmpty()"><strong>Não foi encontrado nenhum profissional!</strong></div>
                                ...
                                <table class="table bordered striped">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr ng-repeat="profissional in controller.profissionalList">
                                            ...
                                            <td data-label="Profissão" class="td">{{profissional.profissao}}</td>
