                                ...
                                <div class="form1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field inline col s12 l6 m6">                                            
                                            ...
                                            <span class="error" ng-class="error" ng-show="instituicaoForm.email.$error.maxlength">Não é permitido mais que 60 caracteres!</span>
                                        </div> 
                                    </div> 
                                    <div class="row">
                                        <div class="input-field inline col s12 l6 m6">                                            
                                            ...
                                            <span class="error" ng-class="error" ng-show="instituicaoForm.telefone.$error.maxlength">Não é permitido mais que 20 caracteres!</span>
                                        </div> 
                                        <div class="input-field inline col s12 l6 m6">                                            
                                            <input id="versao" type="text" name="versao" readonly placeholder="Versão" ng-model="controller.instituicao.confVersao">
                                ...
                                <div class="form2">
                                    ...
                                    <div class="row">
                                        <div class="input-field inline col s12 l4 m4">                                            
                                            ...
                                            <span class="error" ng-class="error" ng-show="instituicaoForm.endereco.$error.maxlength">Não é permitido mais que 60 caracteres!</span>
                                        </div> 
                                        <div class="input-field inline col s12 l4 m4">                                            
                                            <input id="numero" type="text" name="numero" class="validate" placeholder="Número" ng-model="controller.instituicao.numero" ng-class="{'error-form':instituicaoForm.numero.$error.maxlength}"  ng-maxlength="15">
                                            <label for="numero">Número</label>
                                            <span class="error" ng-class="error" ng-show="instituicaoForm.numero.$error.maxlength">Não é permitido mais que 15 caracteres!</span>
                                        </div> 
                                        <div class="input-field inline col s12 l4 m4">                                            
                                            ...
                                            <span class="error" ng-class="error" ng-show="instituicaoForm.bairro.$error.maxlength">Não é permitido mais que 60 caracteres!</span>
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="input-field inline col s12 l4 m4">                                            
                                            ...
                                            <span class="error" ng-class="error" ng-show="instituicaoForm.cidade.$error.maxlength">Não é permitido mais que 60 caracteres!</span>
                                        </div> 
                                        <div class="input-field inline col s12 l4 m4">                                            
                                            ...
                                            <span class="error" ng-class="error" ng-show="instituicaoForm.uf.$error.maxlength">Não é permitido mais que 2 caracteres!</span>
                                        </div> 
                                        <div class="input-field inline col s12 l4 m4">                                            
